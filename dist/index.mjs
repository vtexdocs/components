...
var SearchSection = ({ dataElement, index }) => {
  ...
  if (!dataElement) {
    return /* @__PURE__ */ jsxs41(Flex17, { sx: styles_default17.sectionContainer(), onClick: () => updateFilter(""), children: [
      /* @__PURE__ */ jsx53(
        Text12,
        {
      ...
      allCountLabel !== void 0 && /* @__PURE__ */ jsx53(Box18, { className: "search-section-count", sx: styles_default17.sectionCount, children: allCountLabel })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxs41(
    Flex17,
    {
      sx: styles_default17.sectionContainer(isDisabled),
      onClick: () => {
        if (isDisabled)
          return;
      ...
      children: [
        /* @__PURE__ */ jsxs41(Flex17, { sx: styles_default17.sectionIconTitleBox, children: [
          /* @__PURE__ */ jsx53(dataElement.Icon, { sx: styles_default17.sectionIcon(isDisabled) }),
          /* @__PURE__ */ jsx53(
            Text12,
            {
              className: "search-section-title",
              sx: filterSelectedSection === dataElement.id ? styles_default17.sectionTitleActive : styles_default17.sectionTitle(isDisabled),
              children: dataElement.title
            }
          )
        ] }),
        countLabel !== void 0 && /* @__PURE__ */ jsx53(Box18, { className: "search-section-count", sx: styles_default17.sectionCount, children: countLabel })
      ]
    },
...
var SearchResults = () => {
  ...
  return /* @__PURE__ */ jsxs46(Box22, { sx: styles_default20.resultContainer, children: [
    /* @__PURE__ */ jsx58(Text14, { sx: styles_default20.resultText, children: `${messages[locale]["search_results.showing"] || "Showing"} ${formatSearchTabCount(ocurrenceCount[filterSelectedSection]) ?? ""} ${messages[locale]["search_results.results_for"] || "results for"} ${router.query.keyword} ${messages[locale]["search_results.in"] || "in"} ${!filterSelectedSection ? messages[locale]["search_results.all_lowercase"] || "all results" : filterSelectedSection}` }),
    /* @__PURE__ */ jsx58("hr", {}),
...
var SearchFilterTab = ({ filter }) => {
  ...
  return /* @__PURE__ */ jsxs47(
    Flex20,
    {
      sx: styles_default21.tab(isActive, isDisabled),
      onClick: handleClick,
      ...
      children: [
        /* @__PURE__ */ jsx59(
          Text15,
          {
            sx: styles_default21.tabTitle(isActive, isDisabled),
            "data-testid": "doctype-filter-tab-title",
            children: filter || messages[locale]["search_results.all"] || "All results"
          }
        ),
        formattedCount !== void 0 && /* @__PURE__ */ jsx59(Text15, { sx: styles_default21.tabCount, "data-testid": "doctype-filter-tab-count", children: formattedCount })
      ]
    }
  );
};
var SearchFilterTabBar = () => {
  ...
  return /* @__PURE__ */ jsxs47(Flex20, { sx: styles_default21.container, "data-testid": "doctype-filter-tab-bar", children: [
...
import { useContext as useContext19, useState as useState17 } from "react";
import { Box as Box24, Button as Button8, Text as Text17, Flex as Flex24, Link as Link10 } from "@vtex/brand-ui";
...
var SubscriptionList = () => {
  ...
  const [messageType, setMessageType] = useState17("");
