...
var HitsBox = connectStateResults(
  ({ searchState, searchResults, changeFocus }) => {
    ...
    return /* @__PURE__ */ jsx38(Fragment5, { children: searchResults && /* @__PURE__ */ jsx38(Box14, { sx: styles_default15.resultsOuterContainer, children: /* @__PURE__ */ jsxs31(Box14, { sx: styles_default15.resultsInnerContainer, children: [
