    ...
    visible && (isCard ?? true) && /* @__PURE__ */ jsxs7(
      Flex4,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx11(Box5, { sx: styles_default5.labelStyle(isCard ?? false), children: label3 })
        ]
      }
    )
  ] });
...
var CopyHeadingLink = ({
  ...
  const label3 = copied ? copiedLabel : copyLabel;
...
var SearchBoxComponent = ({
  ...
  useEffect11(() => {
    ...
    const onKeyDown = (event) => {
      ...
      if (!input2 || input2.offsetParent === null)
        return;
      event.preventDefault();
      input2.focus();
      changeFocus(true);
...
import { Box as Box24 } from "@vtex/brand-ui";

// src/components/search-section/index.tsx
import { Box as Box23, Flex as Flex21, Text as Text14 } from "@vtex/brand-ui";
import { useContext as useContext16, useEffect as useEffect16 } from "react";
...
var SearchContextProvider = ({ children }) => {
  const [filterSelectedSection, changeFilterSelectedSection] = useState18("");
  const [ocurrenceCount, changeOcurrenceCount] = useState18({});
...
var SearchSection = ({ dataElement, index }) => {
  ...
  const { filterSelectedSection, ocurrenceCount, changeFilterSelectedSection } = useContext16(SearchContext);
  const { locale, sidebarDataMaster } = useContext16(LibraryContext);
  ...
  if (!dataElement) {
    return /* @__PURE__ */ jsxs48(Flex21, { sx: styles_default22.sectionContainer(), onClick: () => updateFilter(""), children: [
      /* @__PURE__ */ jsx61(
        Text14,
        {
          className: "search-section-title",
          sx: filterSelectedSection ? styles_default22.allResultsText : styles_default22.allResultsTextActive,
          children: messages[locale]["search_results.all"] || "All results"
        }
      ),
      allCountLabel !== void 0 && /* @__PURE__ */ jsx61(Box23, { className: "search-section-count", sx: styles_default22.sectionCount, children: allCountLabel })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxs48(
    Flex21,
    {
      sx: styles_default22.sectionContainer(isDisabled),
      onClick: () => {
        if (isDisabled)
          return;
      ...
      children: [
        /* @__PURE__ */ jsxs48(Flex21, { sx: styles_default22.sectionIconTitleBox, children: [
          /* @__PURE__ */ jsx61(dataElement.Icon, { sx: styles_default22.sectionIcon(isDisabled) }),
          /* @__PURE__ */ jsx61(
            Text14,
            {
              className: "search-section-title",
              sx: filterSelectedSection === dataElement.id ? styles_default22.sectionTitleActive : styles_default22.sectionTitle(isDisabled),
              children: getSectionLabel(dataElement, sidebarDataMaster, locale)
            }
          )
        ] }),
        countLabel !== void 0 && /* @__PURE__ */ jsx61(Box23, { className: "search-section-count", sx: styles_default22.sectionCount, children: countLabel })
      ]
    },
...
var SearchSections = () => {
  ...
  return /* @__PURE__ */ jsx62(Box24, { sx: styles_default23.container, children: internalOnlySections.map((sections, id) => /* @__PURE__ */ jsxs49(
    Box24,
    {
      sx: id < internalOnlySections.length - 1 ? styles_default23.docsSection : styles_default23.notesSection,
      children: [
        id === 0 && /* @__PURE__ */ jsx62(search_section_default, { dataElement: null }),
        sections.map((section, index) => /* @__PURE__ */ jsx62(
...
import { useContext as useContext20, useEffect as useEffect19, useState as useState20 } from "react";
import { Box as Box27, Text as Text17 } from "@vtex/brand-ui";
...
import { useContext as useContext19, useEffect as useEffect18, useMemo as useMemo4, useRef as useRef12 } from "react";
import {
  connectInfiniteHits,
...
import { Box as Box25, Flex as Flex22, Text as Text15, IconCaret as IconCaret6, Tooltip as Tooltip2 } from "@vtex/brand-ui";
import { useContext as useContext18, useEffect as useEffect17, useState as useState19 } from "react";
...
var SearchCard = ({
  ...
  const [toggleChildResults, setToggleChildResults] = useState19(false);
  ...
  return /* @__PURE__ */ jsxs51(Flex22, { sx: styles_default24.containerActive, children: [
    /* @__PURE__ */ jsx64(Link9, { href: url, legacyBehavior: true, children: /* @__PURE__ */ jsx64("a", { children: /* @__PURE__ */ jsxs51(Flex22, { sx: styles_default24.cardBody, children: [
      /* @__PURE__ */ jsx64(Box25, { className: "search-card-icon-wrap", sx: styles_default24.iconWrap, children: /* @__PURE__ */ jsx64(DocIcon, { className: "search-card-icon", sx: styles_default24.icon }) }),
      /* @__PURE__ */ jsxs51(Box25, { sx: styles_default24.cardText, children: [
        /* @__PURE__ */ jsxs51(Text15, { className: "searchCardTitle", sx: styles_default24.title, children: [
          method ? /* @__PURE__ */ jsx64(
            method_category_default,
            {
              sx: styles_default24.httpMethod,
              origin: "search",
              method,
              active: false
            }
          ) : null,
          /* @__PURE__ */ jsx64(Text15, { as: "span", sx: styles_default24.titleText, children: /* @__PURE__ */ jsx64(HighlightQuery, { text: displayTitle, query }) })
        ] }),
        /* @__PURE__ */ jsxs51(Text15, { className: "searchCardDescription", sx: styles_default24.description, children: [
          /* @__PURE__ */ jsx64(
          ...
          toggleChildResults && hit.filteredMatches?.map((childHit, index) => /* @__PURE__ */ jsx64(
            Box25,
            {
              sx: styles_default24.descriptionExpandedItem,
        ...
        crumbs.length > 0 ? /* @__PURE__ */ jsxs51(Box25, { sx: styles_default24.breadcrumbsContainer, children: [
          /* @__PURE__ */ jsx64(Text15, { sx: styles_default24.breadcrumbsIn, children: messages[locale]["search_card.in"] || "In" }),
          crumbs.map((breadcrumb3, index) => /* @__PURE__ */ jsxs51(
            Flex22,
            {
              sx: index === 0 ? styles_default24.documentation : styles_default24.alignCenter,
              children: [
                /* @__PURE__ */ jsx64(Tooltip2, { label: breadcrumb3, placement: "top", children: /* @__PURE__ */ jsx64(Text15, { sx: styles_default24.breadcrumb, children: breadcrumb3 }) }),
                index < crumbs.length - 1 ? /* @__PURE__ */ jsx64(
                  IconCaret6,
                  {
                    direction: "right",
                    sx: styles_default24.breadcrumbsArrow
                  }
                ) : null
              ]
            },
        ...
        actionValue ? /* @__PURE__ */ jsxs51(Flex22, { sx: styles_default24.actionContainer, children: [
          /* @__PURE__ */ jsx64(actionValue.Icon, { sx: styles_default24.actionIcon }),
          " ",
          /* @__PURE__ */ jsx64(Text15, { children: actionValue?.title })
        ] }) : null
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxs51(Flex22, { sx: styles_default24.cardToolbar, children: [
      /* @__PURE__ */ jsxs51(Flex22, { className: "search-card-actions", sx: styles_default24.cardActions, children: [
        /* @__PURE__ */ jsx64(
          Box25,
          {
            as: "button",
            type: "button",
            sx: copied ? styles_default24.actionButtonCopied : styles_default24.actionButton,
            "aria-label": copied ? messages[locale]["search_input.copied"] || "Copied" : messages[locale]["search_input.copy_link"] || "Copy link",
            title: copied ? messages[locale]["search_input.copied"] || "Copied" : messages[locale]["search_input.copy_link"] || "Copy link",
            onClick: handleCopy,
            onMouseDown: (event) => event.preventDefault(),
            children: /* @__PURE__ */ jsx64(copy_icon_default, { size: 14 })
          }
        ),
        /* @__PURE__ */ jsx64(
          Box25,
          {
            as: "button",
            type: "button",
            sx: styles_default24.actionButton,
            "aria-label": messages[locale]["search_input.open_new_tab"] || "Open in new tab",
            title: messages[locale]["search_input.open_new_tab"] || "Open in new tab",
            onClick: handleOpenNewTab,
            onMouseDown: (event) => event.preventDefault(),
            children: /* @__PURE__ */ jsx64(external_link_icon_default, { size: 14 })
          }
        )
      ] }),
      hit.filteredMatches && hit.filteredMatches.length > 0 && /* @__PURE__ */ jsx64(
        Box25,
        {
          sx: styles_default24.descriptionToggle,
          onClick: (event) => {
            setToggleChildResults(!toggleChildResults);
            event.stopPropagation();
          },
          children: /* @__PURE__ */ jsx64(expanded_results_icon_default, { active: toggleChildResults })
        }
      )
    ] })
  ] });
...
// src/components/search-results/infiniteHits.tsx
import { Box as Box26, Flex as Flex23, Text as Text16 } from "@vtex/brand-ui";
...
var StateResults = connectStateResults2(
  ({ searchResults }) => {
    const { updateOcurrenceCount } = useContext19(SearchContext);
    useEffect18(() => {
      if (!searchResults)
        return;
...
var InfiniteHits = ({ hits, hasMore, refineNext }) => {
  ...
  return /* @__PURE__ */ jsxs52(Box26, { children: [
    /* @__PURE__ */ jsx65(StateResults, {}),
    filteredResult.length === 0 && /* @__PURE__ */ jsx65(Flex23, { sx: styles_default25.noResults, children: /* @__PURE__ */ jsx65(Text16, { children: messages[locale]["search_input.empty"] || "No results found. Try different search terms." }) }),
    filteredResult.map((hit, index) => /* @__PURE__ */ jsx65(Flex23, { sx: styles_default25.hitListItem, children: /* @__PURE__ */ jsx65(HitCard, { hit }, index) }, hit.objectID)),
    /* @__PURE__ */ jsx65("span", { ref: scrollRef })
  ] });
};
...
var SearchResults = () => {
  ...
  const { filterSelectedSection, ocurrenceCount } = useContext20(SearchContext);
  ...
  const [prevFilter, setPrevFilter] = useState20("");
  const [prevKeyword, setPrevKeyword] = useState20(keyword);
  const [searchState, setSearchState] = useState20({});
  useEffect19(() => {
  ...
  return /* @__PURE__ */ jsxs53(Box27, { sx: styles_default25.resultContainer, children: [
    /* @__PURE__ */ jsxs53(Text17, { sx: styles_default25.resultText, children: [
      `${messages[locale]["search_results.showing"] || "Showing"} `,
      /* @__PURE__ */ jsx66(Text17, { as: "span", sx: styles_default25.resultCount, children: formatSearchTabCount(ocurrenceCount[filterSelectedSection]) ?? "" }),
      ` ${messages[locale]["search_results.results_for"] || "results for"} `,
      /* @__PURE__ */ jsx66(Text17, { as: "span", sx: styles_default25.resultKeyword, children: `\u201C${router.query.keyword}\u201D` }),
    ...
    /* @__PURE__ */ jsx66("hr", {}),
    /* @__PURE__ */ jsx66(Box27, { children: /* @__PURE__ */ jsxs53(
      InstantSearch2,
      {
        searchClient,
        ...
        children: [
          ...
          /* @__PURE__ */ jsx66(infiniteHits_default, {}, keyword)
        ]
      }
    ) })
  ] });
...
var styles_default26 = { container: container11, tab, tabIcon, tabTitle, tabCount };
...
var SearchFilterTab = ({
  ...
  const { filterSelectedSection, changeFilterSelectedSection, ocurrenceCount } = useContext21(SearchContext);
  ...
  return /* @__PURE__ */ jsxs54(
    Flex24,
    {
      sx: styles_default26.tab(isActive),
      onClick: () => changeFilterSelectedSection(filter),
      "data-testid": "doctype-filter-tab",
      "data-filter": filter,
      "data-active": String(isActive),
      children: [
        Icon73 ? /* @__PURE__ */ jsx67(Icon73, { sx: styles_default26.tabIcon(isActive) }) : null,
        /* @__PURE__ */ jsx67(
          Text18,
          {
            sx: styles_default26.tabTitle(isActive),
            "data-testid": "doctype-filter-tab-title",
            children: filter === "" ? messages[locale]["search_results.all"] || "All results" : label3 || filter
          }
        ),
        formattedCount !== void 0 && /* @__PURE__ */ jsx67(
          Text18,
          {
            sx: styles_default26.tabCount(isActive),
...
var SearchFilterTabBar = () => {
  const { sidebarSections, sidebarDataMaster, locale } = useContext21(LibraryContext);
  const { ocurrenceCount, filterSelectedSection, changeFilterSelectedSection } = useContext21(SearchContext);
  const countsLoaded = Object.keys(ocurrenceCount).length > 0;
  ...
  return /* @__PURE__ */ jsxs54(Flex24, { sx: styles_default26.container, "data-testid": "doctype-filter-tab-bar", children: [
    /* @__PURE__ */ jsx67(SearchFilterTab, { filter: "" }),
    visibleSections.map((section) => /* @__PURE__ */ jsx67(
      SearchFilterTab,
      {
        filter: section.id,
...
var Search = () => {
  return /* @__PURE__ */ jsxs55(search_default, { children: [
    /* @__PURE__ */ jsx68(search_filter_tab_bar_default, {}),
    /* @__PURE__ */ jsxs55(Flex25, { sx: styles_default27.body, children: [
      /* @__PURE__ */ jsx68(search_sections_default, {}),
      /* @__PURE__ */ jsx68(search_results_default, {})
    ] })
  ] });
};
...
var Button6 = ({ children, style, ...props }) => {
  return /* @__PURE__ */ jsx69(Flex26, { sx: style, ...props, children });
};
var CookieBar = ({ onAccept }) => {
  ...
  return /* @__PURE__ */ jsxs56(
    CookieConsent,
    {
      ...
      buttonStyle: styles_default28.acceptButton,
      declineButtonStyle: styles_default28.declineButton,
      style: styles_default28.bar,
      onAccept: () => {
        aa3("init", {
          partial: true,
          useCookie: true
      ...
      customButtonWrapperAttributes: { style: styles_default28.buttonContainer },
      customContentAttributes: { style: styles_default28.barContent },
      children: [
        /* @__PURE__ */ jsx69(Text19, { sx: styles_default28.title, children: messages[locale]["cookie_bar.title"] }),
        /* @__PURE__ */ jsx69(Text19, { children: messages[locale]["cookie_bar.description"] })
      ]
    }
  );
};
...
var CopyLinkButton = () => {
  const [tooltipText, setTooltipText] = useState21("Copy");
  const handleCopy = () => {
  ...
  return /* @__PURE__ */ jsx70(tooltip_default, { label: tooltipText, placement: "bottom", children: /* @__PURE__ */ jsx70(Button7, { onClick: handleCopy, sx: styles_default29.copyLinkButton, children: /* @__PURE__ */ jsx70(copy_icon_default, { sx: styles_default29.copyIcon, size: 16 }) }) });
};
var copy_link_button_default = CopyLinkButton;

// src/components/copy-button/index.tsx
import { useCallback as useCallback3, useState as useState22, useRef as useRef13, useEffect as useEffect21 } from "react";
import copy2 from "copy-text-to-clipboard";
import { Box as Box28, Button as Button8, Icon as Icon34 } from "@vtex/brand-ui";
...
var CopyButton = ({ code, sx }) => {
  ...
  useEffect21(() => () => window.clearTimeout(copyTimeout.current), []);
  return /* @__PURE__ */ jsx71(
    Button8,
    {
      ...
      sx: {
        ...isCopied ? styles_default30.copyButtonCopied : styles_default30.copyButton,
        ...sx
      },
      "aria-label": "Copy code snippet",
      children: /* @__PURE__ */ jsxs57(Box28, { sx: styles_default30.copyButtonIcons, "aria-hidden": "true", children: [
        /* @__PURE__ */ jsx71(
          Icon34,
          {
            size: 16,
            sx: isCopied ? styles_default30.copyButtonIconCopied : styles_default30.copyButtonIcon,
            children: /* @__PURE__ */ jsx71("path", { d: "M19,21H8V7H19M19,5H8A2,2 0 0,0 6,7V21A2,2 0 0,0 8,23H19A2,2 0 0,0 21,21V7A2,2 0 0,0 19,5M16,1H4A2,2 0 0,0 2,3V17H4V3H16V1Z" })
          }
        ),
        /* @__PURE__ */ jsx71(
          Icon34,
          {
            size: 16,
            sx: isCopied ? styles_default30.copyButtonSuccessIcon : styles_default30.copyButtonSuccessIconCopied,
            children: /* @__PURE__ */ jsx71("path", { d: "M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" })
          }
        )
      ] })
    }
...
import { useContext as useContext23, useEffect as useEffect22, useRef as useRef14, useState as useState23 } from "react";
import copy3 from "copy-text-to-clipboard";
import { Box as Box29, Text as Text20, IconCaret as IconCaret7 } from "@vtex/brand-ui";

// src/components/icons/chatgpt-icon.tsx
import { Icon as Icon35 } from "@vtex/brand-ui";
import { jsx as jsx72 } from "react/jsx-runtime";
var ChatGPTIcon = (props) => /* @__PURE__ */ jsx72(
  Icon35,
  {
    ...props,
    fill: "currentColor",
...
var CopilotIcon = (props) => /* @__PURE__ */ jsx73(
  Icon36,
  {
    ...props,
    fill: "currentColor",
    ...
    width: "64",
    xmlns: "http://www.w3.org/2000/svg",
    children: /* @__PURE__ */ jsx73("path", { d: "M9 23l.073-.001a2.53 2.53 0 01-2.347-1.838l-.697-2.433a2.529 2.529 0 00-2.426-1.839h-.497l-.104-.002c-4.485 0-2.935-5.278-1.75-9.225l.162-.525C2.412 3.99 3.883 1 6.25 1h8.86c1.12 0 2.106.745 2.422 1.829l.715 2.453a2.53 2.53 0 002.247 1.823l.147.005.534.001c3.557.115 3.088 3.745 2.156 7.206l-.113.413c-.154.548-.315 1.089-.47 1.607l-.163.525C21.588 20.01 20.116 23 17.75 23h-8.75zm8.22-15.89l-3.856.001a2.526 2.526 0 00-2.35 1.615L9.21 15.04a2.529 2.529 0 01-2.43 1.847l3.853.002c1.056 0 1.992-.661 2.361-1.644l1.796-6.287a2.529 2.529 0 012.43-1.848z" })
  }
);
...
var ClaudeIcon = (props) => /* @__PURE__ */ jsxs58(
  Icon37,
  {
    ...props,
    fill: "currentColor",
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      /* @__PURE__ */ jsx74("title", { children: "Claude" }),
      /* @__PURE__ */ jsx74("path", { d: "M4.709 15.955l4.72-2.647.08-.23-.08-.128H9.2l-.79-.048-2.698-.073-2.339-.097-2.266-.122-.571-.121L0 11.784l.055-.352.48-.321.686.06 1.52.103 2.278.158 1.652.097 2.449.255h.389l.055-.157-.134-.098-.103-.097-2.358-1.596-2.552-1.688-1.336-.972-.724-.491-.364-.462-.158-1.008.656-.722.881.06.225.061.893.686 1.908 1.476 2.491 1.833.365.304.145-.103.019-.073-.164-.274-1.355-2.446-1.446-2.49-.644-1.032-.17-.619a2.97 2.97 0 01-.104-.729L6.283.134 6.696 0l.996.134.42.364.62 1.414 1.002 2.229 1.555 3.03.456.898.243.832.091.255h.158V9.01l.128-1.706.237-2.095.23-2.695.08-.76.376-.91.747-.492.584.28.48.685-.067.444-.286 1.851-.559 2.903-.364 1.942h.212l.243-.242.985-1.306 1.652-2.064.73-.82.85-.904.547-.431h1.033l.76 1.129-.34 1.166-1.064 1.347-.881 1.142-1.264 1.7-.79 1.36.073.11.188-.02 2.856-.606 1.543-.28 1.841-.315.833.388.091.395-.328.807-1.969.486-2.309.462-3.439.813-.042.03.049.061 1.549.146.662.036h1.622l3.02.225.79.522.474.638-.079.485-1.215.62-1.64-.389-3.829-.91-1.312-.329h-.182v.11l1.093 1.068 2.006 1.81 2.509 2.33.127.578-.322.455-.34-.049-2.205-1.657-.851-.747-1.926-1.62h-.128v.17l.444.649 2.345 3.521.122 1.08-.17.353-.608.213-.668-.122-1.374-1.925-1.415-2.167-1.143-1.943-.14.08-.674 7.254-.316.37-.729.28-.607-.461-.322-.747.322-1.476.389-1.924.315-1.53.286-1.9.17-.632-.012-.042-.14.018-1.434 1.967-2.18 2.945-1.726 1.845-.414.164-.717-.37.067-.662.401-.589 2.388-3.036 1.44-1.882.93-1.086-.006-.158h-.055L4.132 18.56l-1.13.146-.487-.456.061-.746.231-.243 1.908-1.312-.006.006z" })
    ]
  }
);
...
var GeminiIcon = (props) => /* @__PURE__ */ jsx75(
  Icon38,
  {
    ...props,
    fill: "currentColor",
...
var LongArrowIcon = (props) => /* @__PURE__ */ jsxs59(
  Icon39,
  {
    ...props,
    viewBox: "0 0 24 24",
...
var MarkdownIcon = (props) => /* @__PURE__ */ jsxs60(
  Icon40,
  {
    ...props,
    viewBox: "0 0 208 128",
...
var CheckIcon = (props) => /* @__PURE__ */ jsx78(
  Icon41,
  {
    ...props,
    viewBox: "0 0 16 16",
...
var ProviderIcon = ({ id, size = 14 }) => {
  switch (id) {
    case "chatgpt":
      return /* @__PURE__ */ jsx79(chatgpt_icon_default, { size });
    case "copilot":
      return /* @__PURE__ */ jsx79(copilot_icon_default, { size });
    case "claude":
      return /* @__PURE__ */ jsx79(claude_icon_default, { size });
    case "gemini":
      return /* @__PURE__ */ jsx79(gemini_icon_default, { size });
    default:
      return null;
  }
};
var AskAIMenu = ({
  ...
  return /* @__PURE__ */ jsxs61(Box29, { ref: menuRef, sx: styles_default31.container, children: [
    /* @__PURE__ */ jsxs61(Box29, { sx: styles_default31.group, children: [
      /* @__PURE__ */ jsxs61(
        Box29,
        {
          as: "button",
          type: "button",
          sx: styles_default31.primaryBtn,
          onClick: handleCopy,
          "aria-label": isCopied ? copiedLabel : copyLabel,
          disabled: isLoading,
          children: [
            isCopied ? /* @__PURE__ */ jsx79(check_icon_default, { size: 14 }) : /* @__PURE__ */ jsx79(markdown_icon_default, { size: 14 }),
            /* @__PURE__ */ jsx79(Text20, { children: isCopied ? copiedLabel : copyLabel })
          ]
        }
      ),
      /* @__PURE__ */ jsx79(
        Box29,
        {
          as: "button",
          type: "button",
          sx: styles_default31.caretBtn,
          onClick: () => setOpen((isOpen) => !isOpen),
          "aria-haspopup": "menu",
          "aria-expanded": open,
          "aria-controls": "askai-menu",
          children: /* @__PURE__ */ jsx79(IconCaret7, { direction: open ? "up" : "down" })
        }
      )
    ] }),
    open && /* @__PURE__ */ jsxs61(Box29, { id: "askai-menu", sx: styles_default31.askaiMenu, role: "menu", children: [
      /* @__PURE__ */ jsx79(Box29, { sx: styles_default31.askaiSection, children: providers.map((provider) => /* @__PURE__ */ jsxs61(
        Box29,
        {
          as: "button",
          sx: styles_default31.askaiItem,
          onClick: () => handleProvider(provider),
          role: "menuitem",
          "aria-label": `Open ${provider.name}`,
          children: [
            /* @__PURE__ */ jsx79(ProviderIcon, { id: provider.id, size: 12 }),
            /* @__PURE__ */ jsxs61("span", { children: [
              provider.name,
              " ",
              /* @__PURE__ */ jsx79(long_arrow_icon_default, { size: 12 })
            ] })
          ]
        },
        `lu-${provider.id}`
      )) }),
      /* @__PURE__ */ jsx79(Box29, { sx: styles_default31.askaiSection, children: /* @__PURE__ */ jsxs61(
        Box29,
        {
          as: "button",
          sx: styles_default31.askaiItem,
          ...
          children: [
            /* @__PURE__ */ jsx79(markdown_icon_default, { size: 12 }),
            viewLabel
          ]
        }
      ) })
...
var styles_default32 = { breadcrumb: breadcrumb2, crumb };
...
var Breadcrumb = ({
  ...
  return /* @__PURE__ */ jsx80(Flex27, { as: "nav", "aria-label": "Breadcrumb", sx: styles_default32.breadcrumb, children: items.map((item2, idx) => {
    const label3 = item2.name || "Untitled";
    return /* @__PURE__ */ jsx80(Flex27, { as: "span", sx: styles_default32.crumb, children: item2.type === "markdown" ? /* @__PURE__ */ jsx80(Link10, { href: item2.slug, children: label3 }) : /* @__PURE__ */ jsx80("span", { "data-breadcrumb-label": true, children: label3 }) }, item2.slug || idx);
  }) });
};
...
var styles_default33 = { container: container13, input, icon: icon3 };

// src/components/input/index.tsx
import { Flex as Flex28 } from "@vtex/brand-ui";
import { jsx as jsx81, jsxs as jsxs62 } from "react/jsx-runtime";
var Input = ({ value, onChange, placeholder = "", Icon: Icon73 }) => {
  const [inputValue, setInputValue] = useState24(value ?? "");
  useEffect23(() => {
    if (inputValue !== value)
      setInputValue(value);
  }, [value]);
  return /* @__PURE__ */ jsxs62(Flex28, { sx: styles_default33.container, children: [
    Icon73 && /* @__PURE__ */ jsx81(Icon73, { sx: styles_default33.icon }),
    /* @__PURE__ */ jsx81(
      "input",
      {
        style: styles_default33.input,
        value: inputValue,
        placeholder,
        onChange: (e) => {
...
import { useContext as useContext24, useState as useState25 } from "react";
import { Box as Box30, Button as Button9, Text as Text21, Flex as Flex29, Link as Link11 } from "@vtex/brand-ui";
...
var SubscriptionList = () => {
  ...
  const [messageType, setMessageType] = useState25("");
  ...
  return /* @__PURE__ */ jsxs63(Box30, { sx: styles_default34.sectionContainer, children: [
    /* @__PURE__ */ jsx82(Text21, { sx: styles_default34.title, children: localizedMessages["landing_page_subscription.title"] }),
    /* @__PURE__ */ jsx82(Flex29, { sx: styles_default34.cardContainer, children: /* @__PURE__ */ jsxs63("div", { children: [
      /* @__PURE__ */ jsxs63(Text21, { sx: styles_default34.description, children: [
      ...
      /* @__PURE__ */ jsxs63(Flex29, { sx: styles_default34.inputContainer, children: [
        /* @__PURE__ */ jsx82(
          Box30,
          {
            as: "input",
            ...
            sx: styles_default34.emailInputField
          }
        ),
        /* @__PURE__ */ jsx82(
          Button9,
          {
            ...
            sx: styles_default34.button,
            children: localizedMessages["landing_page_newsletter.Button"]
          }
        )
      ] }),
      /* @__PURE__ */ jsxs63(Text21, { sx: styles_default34.privacyText, children: [
      ...
      message && /* @__PURE__ */ jsx82(
        Box30,
        {
          sx: {
            ...styles_default34.popupCard,
            backgroundColor: messageType === "success" ? "#dff1e0" : "#f8e3e3"
          },
          children: /* @__PURE__ */ jsx82(Text21, { children: message })
        }
      )
    ] }) })
  ] });
...
import { Box as Box31, Flex as Flex30, Link as Link12 } from "@vtex/brand-ui";
...
var VTEXLogoFooter = (props) => /* @__PURE__ */ jsxs64(
  Icon42,
  {
    ...props,
    viewBox: "0 0 61 22",
...
var IgIcon = (props) => /* @__PURE__ */ jsxs65(
  Icon43,
  {
    ...props,
    viewBox: "0 0 33 33",
    ...
    children: [
      ...
      /* @__PURE__ */ jsx84("g", { clipPath: "url(#clip0_311_37416)", children: /* @__PURE__ */ jsx84(
        "path",
        {
      ...
      /* @__PURE__ */ jsx84("defs", { children: /* @__PURE__ */ jsx84("clipPath", { id: "clip0_311_37416", children: /* @__PURE__ */ jsx84(
        "rect",
        {
          width: "18.0282",
          height: "18",
...
var YoutubeIcon = (props) => /* @__PURE__ */ jsxs66(
  Icon44,
  {
    ...props,
    viewBox: "0 0 33 33",
    ...
    children: [
      ...
      /* @__PURE__ */ jsx85("g", { clipPath: "url(#clip0_311_37417)", children: /* @__PURE__ */ jsx85(
        "path",
        {
      ...
      /* @__PURE__ */ jsx85("defs", { children: /* @__PURE__ */ jsx85("clipPath", { id: "clip0_311_37417", children: /* @__PURE__ */ jsx85(
        "rect",
        {
          width: "16.025",
          height: "16",
...
var FacebookCircleIcon = (props) => /* @__PURE__ */ jsxs67(
  Icon45,
  {
    ...props,
    viewBox: "0 0 33 33",
    ...
    children: [
      ...
      /* @__PURE__ */ jsx86("g", { clipPath: "url(#clip0_311_37415)", children: /* @__PURE__ */ jsx86(
        "path",
        {
      ...
      /* @__PURE__ */ jsx86("defs", { children: /* @__PURE__ */ jsx86("clipPath", { id: "clip0_311_37415", children: /* @__PURE__ */ jsx86(
        "rect",
        {
          width: "18.0282",
          height: "18",
...
var LinkedinCircleIcon = (props) => /* @__PURE__ */ jsxs68(
  Icon46,
  {
    ...props,
    viewBox: "0 0 33 33",
    ...
    children: [
      ...
      /* @__PURE__ */ jsx87("g", { clipPath: "url(#clip0_311_37418)", children: /* @__PURE__ */ jsx87(
        "path",
        {
      ...
      /* @__PURE__ */ jsx87("defs", { children: /* @__PURE__ */ jsx87("clipPath", { id: "clip0_311_37418", children: /* @__PURE__ */ jsx87(
        "rect",
        {
          width: "18.0282",
          height: "18",
...
var Footer = ({
  ...
  const socialIcons = [
    {
      href: getLinkedinURL(),
      component: /* @__PURE__ */ jsx88(linkedin_circle_icon_default, { sx: styles_default35.icon })
    },
    {
      href: getInstagramURL(),
      component: /* @__PURE__ */ jsx88(instagram_icon_default, { sx: styles_default35.icon })
    },
    {
      href: getYoutubeURL(),
      component: /* @__PURE__ */ jsx88(youtube_icon_default, { sx: styles_default35.icon })
    },
    {
      href: getFacebookURL(),
      component: /* @__PURE__ */ jsx88(facebook_circle_icon_default, { sx: styles_default35.icon })
    }
  ];
  return /* @__PURE__ */ jsxs69(Box31, { sx: styles_default35.outerBox, children: [
    /* @__PURE__ */ jsxs69(Flex30, { sx: styles_default35.brandAndSocial, children: [
      /* @__PURE__ */ jsx88(vtex_logo_footer_default, { sx: styles_default35.logo }),
      /* @__PURE__ */ jsx88(Flex30, { sx: styles_default35.socialMediaIcons, children: socialIcons.map((icon5) => /* @__PURE__ */ jsx88(Link12, { href: icon5.href, children: icon5.component }, icon5.href)) })
    ] }),
    /* @__PURE__ */ jsxs69(Flex30, { sx: styles_default35.textLinkItems, children: [
      resolvedLinks.map((link2) => /* @__PURE__ */ jsx88(Link12, { href: link2.href, children: link2.label }, link2.href)),
      localeSwitcher ? /* @__PURE__ */ jsx88(Box31, { sx: styles_default35.localeSwitch, children: localeSwitcher }) : null
    ] })
  ] });
};
...
import { Link as VtexLink, Flex as Flex31, Text as Text22, Box as Box33 } from "@vtex/brand-ui";
import { useContext as useContext27, useEffect as useEffect24, useRef as useRef15, useState as useState26 } from "react";
...
var VTEXDevPortalIcon = (props) => /* @__PURE__ */ jsxs70(
  Icon47,
  {
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      /* @__PURE__ */ jsx89("g", { clipPath: "url(#clip0_2044_123231)", children: /* @__PURE__ */ jsx89(
        "path",
        {
      ...
      /* @__PURE__ */ jsx89("defs", { children: /* @__PURE__ */ jsx89("clipPath", { id: "clip0_2044_123231", children: /* @__PURE__ */ jsx89(
        "rect",
        {
          width: "85.2157",
          height: "30.4976",
...
var VTEXHelpCenterIcon = (props) => /* @__PURE__ */ jsxs71(
  Icon48,
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx90("path", { d: "M98.7078 0H97.2148V30.4976H98.7078V0Z", fill: "#E31C58" }),
      /* @__PURE__ */ jsx90(
        "path",
        {
...
var GridIcon = (props) => /* @__PURE__ */ jsxs72(
  Icon49,
  {
    ...props,
    viewBox: "0 0 24 24",
...
var DropdownMenu = ({ sections }) => {
  const { locale, sidebarDataMaster } = useContext26(LibraryContext);
  return /* @__PURE__ */ jsx92(Box32, { sx: dropdown_menu_styles_default.outerContainer, children: /* @__PURE__ */ jsx92(Box32, { sx: dropdown_menu_styles_default.innerContainer, "data-cy": "dropdown-menu", children: sections.map((section, id) => /* @__PURE__ */ jsx92(
    Box32,
    {
      sx: {
      ...
      children: section.map((card2) => /* @__PURE__ */ jsx92(
        documentation_card_default,
        {
          containerType: "dropdown",
          ...card2,
...
// src/components/header/index.tsx
import { jsx as jsx93, jsxs as jsxs73 } from "react/jsx-runtime";
...
var Header3 = ({
  ...
  const { locale, hamburguerSections } = useContext27(LibraryContext);
  const localizedMessages = messages[locale] ?? messages.en;
  const modalOpen = useRef15(false);
  const [showDropdown, setShowDropdown] = useState26(false);
  ...
  const defaultLogo = variant === "devportal" ? /* @__PURE__ */ jsx93(vtex_devportal_icon_default, { sx: styles_default36.logoSize }) : /* @__PURE__ */ jsx93(vtex_helpcenter_icon_default, { sx: styles_default36.logoSize });
  useEffect24(() => {
  ...
  return /* @__PURE__ */ jsxs73(Box33, { ref: headerElement, sx: styles_default36.headerContainer, children: [
    announcement ?? /* @__PURE__ */ jsx93("div", {}),
    /* @__PURE__ */ jsxs73(HeaderBrand, { sx: styles_default36.headerBrand, children: [
      /* @__PURE__ */ jsx93(
        VtexLink,
        {
          "aria-label": localizedMessages["header.home_aria"],
          href: homeHref,
          sx: styles_default36.headerBrandLink,
          children: logo2 ?? defaultLogo
        }
      ),
      /* @__PURE__ */ jsx93(Box33, { sx: styles_default36.searchContainer, children: /* @__PURE__ */ jsx93(SearchInput, {}) }),
      /* @__PURE__ */ jsxs73(HeaderBrand.RightLinks, { sx: styles_default36.rightLinks, children: [
        /* @__PURE__ */ jsxs73(
          Flex31,
          {
            sx: styles_default36.dropdownContainer,
            onMouseOver: () => setShowDropdown(true),
            onMouseLeave: () => setShowDropdown(false),
            children: [
              /* @__PURE__ */ jsxs73(Flex31, { sx: styles_default36.dropdownButton(showDropdown), children: [
                /* @__PURE__ */ jsx93(grid_icon_default, {}),
                /* @__PURE__ */ jsx93(Text22, { sx: styles_default36.rightButtonsText, "data-cy": "docs-dropdown", children: isEditor ? localizedMessages["header.admin_tools"] : localizedMessages["header.docs"] })
              ] }),
              showDropdown && /* @__PURE__ */ jsx93(dropdown_menu_default, { sections: menuSections })
            ]
          }
        ),
        extraRightLinks2 ? /* @__PURE__ */ jsx93(Box33, { sx: styles_default36.extraRightLinks, children: extraRightLinks2 }) : null,
        /* @__PURE__ */ jsxs73(
          VtexLink,
          {
            sx: styles_default36.rightLinksItem,
            ...
            children: [
              /* @__PURE__ */ jsx93(long_arrow_icon_default, {}),
              /* @__PURE__ */ jsx93(Text22, { sx: styles_default36.rightButtonsText, children: localizedMessages["header.feedback"] })
            ]
          }
        )
      ] }),
      localeSwitcher ? /* @__PURE__ */ jsxs73(Flex31, { sx: styles_default36.headerEndActions, children: [
        /* @__PURE__ */ jsx93(Box33, { sx: styles_default36.hamburgerMenuToggle, children: /* @__PURE__ */ jsx93(hamburger_menu_default, { parentsArray }) }),
        /* @__PURE__ */ jsx93(Box33, { sx: styles_default36.localeSwitcherSlot, children: localeSwitcher })
      ] }) : /* @__PURE__ */ jsx93(Box33, { sx: styles_default36.hamburgerMenuToggle, children: /* @__PURE__ */ jsx93(hamburger_menu_default, { parentsArray }) })
    ] })
  ] });
};
...
import { Box as Box34, Button as Button10, Text as Text23, Link as Link13, Icon as Icon50 } from "@vtex/brand-ui";
...
var CloseIcon2 = (props) => /* @__PURE__ */ jsxs74(Icon50, { ...props, children: [
  /* @__PURE__ */ jsx94(
    "path",
    {
      d: "M8 8L16 16",
...
var AnnouncementBar = ({
  ...
  if (!visible)
    return null;
  return /* @__PURE__ */ jsxs74(Box34, { sx: styles_default37.container(type), role: "status", "aria-label": "Announcement", children: [
    /* @__PURE__ */ jsxs74(Box34, { sx: styles_default37.box, children: [
      tag4 && /* @__PURE__ */ jsx94(Text23, { sx: styles_default37.label(type), children: tag4 }),
      children ? /* @__PURE__ */ jsx94(Text23, { sx: styles_default37.text, children }) : null,
      label3 ? /* @__PURE__ */ jsx94(Text23, { sx: styles_default37.text, children: label3 }) : null,
      button6 && /* @__PURE__ */ jsx94(Link13, { sx: styles_default37.button(type), target, href, children: button6 })
    ] }),
    closable && /* @__PURE__ */ jsx94(Box34, { children: /* @__PURE__ */ jsx94(
      Button10,
      {
        "aria-label": "Close Announcement Bar",
        sx: styles_default37.closeIcon,
        variant: "tertiary",
        size: "small",
        onClick: (event) => {
          event.stopPropagation();
        ...
        icon: () => /* @__PURE__ */ jsx94(CloseIcon2, {})
      }
    ) })
  ] });
};
...
import { Text as Text24 } from "@vtex/brand-ui";
...
var Tag = ({ sx = {}, children, color = "Default", onClick }) => {
  return /* @__PURE__ */ jsx95(
    Text24,
    {
      sx: { ...styles_default38.tag, ...sx, ...styles_default38.statusColors[color] },
      onClick,
      children
    }
  );
...
import { Box as Box35, Button as Button11, Checkbox, Flex as Flex32, Text as Text25 } from "@vtex/brand-ui";
...
var FilterIcon = (props) => /* @__PURE__ */ jsxs75(
  Icon51,
  {
    ...props,
    viewBox: "0 0 16 17",
...
var TrashcanIcon = (props) => /* @__PURE__ */ jsxs76(
  Icon52,
  {
    ...props,
    viewBox: "0 0 19 18",
...
// src/components/listing-filter/index.tsx
import { Fragment as Fragment9, jsx as jsx98, jsxs as jsxs77 } from "react/jsx-runtime";
var defaultLabels = {
  button: "Filters",
  modalTitle: "Filters",
...
var ListingFilter = ({
  ...
  const [tempFilters, setTempFilters] = useState28({
    tag: [],
    checklist: []
  });
  ...
  const FilterButton = () => /* @__PURE__ */ jsxs77(
    Flex32,
    {
      sx: { ...styles_default39.filterButton, ...buttonSx },
      onClick: () => {
        setTempFilters({
      ...
      children: [
        /* @__PURE__ */ jsx98(filter_icon_default, { size: 16 }),
        /* @__PURE__ */ jsx98(Text25, { sx: styles_default39.filterButtonText, children: resolvedLabels.button }),
        numberOfFilters2 > 0 && /* @__PURE__ */ jsx98(Text25, { sx: styles_default39.numberOfFilters, children: numberOfFilters2 })
      ]
    }
  );
  const TagFilter = () => {
    if (!normalizedTagFilter)
      return null;
    return /* @__PURE__ */ jsxs77(Box35, { sx: styles_default39.filterContainer, children: [
      /* @__PURE__ */ jsx98(Text25, { sx: styles_default39.filterTitle, children: normalizedTagFilter.name }),
      /* @__PURE__ */ jsx98(
        Flex32,
        {
          sx: centeredTagOptions ? styles_default39.tagContainerCentered : styles_default39.tagContainer,
          children: normalizedTagFilter.options.map((option) => /* @__PURE__ */ jsx98(
            tag_default,
            {
              sx: styles_default39.tag,
  ...
  const CheckboxFilters = () => {
    if (checkboxGroups.length === 0)
      return null;
    return /* @__PURE__ */ jsx98(Fragment9, { children: checkboxGroups.map((group2, groupIndex) => /* @__PURE__ */ jsxs77(Box35, { children: [
      groupIndex > 0 && /* @__PURE__ */ jsx98(Divider, {}),
      /* @__PURE__ */ jsxs77(Box35, { sx: styles_default39.filterContainer, children: [
        /* @__PURE__ */ jsx98(Text25, { sx: styles_default39.filterTitle, children: group2.name }),
        /* @__PURE__ */ jsx98(Box35, { sx: styles_default39.checkBoxContainer, children: group2.options.map((option) => /* @__PURE__ */ jsx98(
          Checkbox,
          {
            label: option.name,
  ...
  const Divider = () => /* @__PURE__ */ jsx98(Box35, { sx: styles_default39.sectionDivider, children: /* @__PURE__ */ jsx98("hr", {}) });
  const FilterModal = () => /* @__PURE__ */ jsxs77(Fragment9, { children: [
    /* @__PURE__ */ jsx98(Box35, { sx: styles_default39.blanket, onClick: () => setIsModalOpen(false) }),
    /* @__PURE__ */ jsxs77(Box35, { sx: styles_default39.container, children: [
      /* @__PURE__ */ jsxs77(Box35, { sx: styles_default39.topContainer, children: [
        /* @__PURE__ */ jsx98(Text25, { sx: styles_default39.modalTitle, children: resolvedLabels.modalTitle }),
        /* @__PURE__ */ jsx98(
          Flex32,
          {
            sx: styles_default39.closeButtonContainer,
            onClick: () => setIsModalOpen(false),
            children: /* @__PURE__ */ jsx98(close_icon_default, { size: 32 })
          }
        )
      ] }),
      /* @__PURE__ */ jsxs77(Box35, { sx: styles_default39.innerContainer, children: [
        /* @__PURE__ */ jsx98(TagFilter, {}),
        normalizedTagFilter && checkboxGroups.length > 0 && /* @__PURE__ */ jsx98(Divider, {}),
        /* @__PURE__ */ jsx98(CheckboxFilters, {})
      ] }),
      /* @__PURE__ */ jsxs77(Flex32, { sx: styles_default39.buttonsContainer, children: [
        /* @__PURE__ */ jsx98(
          Button11,
          {
            sx: styles_default39.removeButton,
            icon: () => /* @__PURE__ */ jsx98(trashcan_icon_default, { sx: { mr: "8px" }, size: 18 }),
  ...
  return /* @__PURE__ */ jsxs77(Fragment9, { children: [
    /* @__PURE__ */ jsx98(FilterButton, {}),
    isModalOpen && /* @__PURE__ */ jsx98(FilterModal, {})
  ] });
};
var listing_filter_default = ListingFilter;

// src/components/chip-filter/index.tsx
import { Box as Box36, Flex as Flex33, Button as Button12, Text as Text26 } from "@vtex/brand-ui";
import { useEffect as useEffect26, useRef as useRef16, useState as useState29 } from "react";
...
var ChipFilter = ({
  ...
  const [shouldDisplayArrows, setShouldDisplayArrows] = useState29({ left: false, right: false });
  ...
  return /* @__PURE__ */ jsxs78(Flex33, { sx: styles_default40.chipButtonWrapper, children: [
    shouldDisplayArrows.left && /* @__PURE__ */ jsxs78(Box36, { sx: styles_default40.leftArrowContainer, children: [
      /* @__PURE__ */ jsx99(
        Button12,
        {
          variant: "tertiary",
          size: "small",
          sx: styles_default40.arrowButton,
          onClick: handleLeftArrowClick,
          children: `\u2039`
        }
      ),
      /* @__PURE__ */ jsx99(Box36, { sx: styles_default40.leftArrowBlur })
    ] }),
    /* @__PURE__ */ jsx99(
      Box36,
      {
        sx: styles_default40.chipsContainer,
        ref: containerRef,
        onScroll: handleContainerScroll,
        children: /* @__PURE__ */ jsxs78(Box36, { sx: styles_default40.optionsContainer, children: [
          /* @__PURE__ */ jsx99(
            FilterChip,
            {
          ...
          categories.map((category) => /* @__PURE__ */ jsx99(
            FilterChip,
            {
    ...
    shouldDisplayArrows.right && /* @__PURE__ */ jsxs78(Box36, { sx: styles_default40.rightArrowContainer, children: [
      /* @__PURE__ */ jsx99(
        Button12,
        {
          variant: "tertiary",
      ...
      /* @__PURE__ */ jsx99(Box36, { sx: styles_default40.rightArrowBlur })
    ] })
  ] });
};
function FilterChip({
  ...
  return /* @__PURE__ */ jsxs78(Flex33, { sx: styles_default40.chip(isActive), onClick: applyCategory, children: [
    Icon73 ? /* @__PURE__ */ jsx99(Icon73, { sx: styles_default40.chipIcon }) : null,
    /* @__PURE__ */ jsx99(Text26, { className: "filter-chip-title", sx: styles_default40.chipTitle(isActive), children: value }),
    /* @__PURE__ */ jsx99(Text26, { sx: styles_default40.chipCount, children: count2 })
  ] });
}
var chip_filter_default = ChipFilter;

// src/components/author/index.tsx
import { Box as Box37, Flex as Flex34, Text as Text27 } from "@vtex/brand-ui";
...
var Author = ({ contributor }) => {
  return /* @__PURE__ */ jsxs79(Flex34, { sx: styles_default41.container, children: [
    /* @__PURE__ */ jsx100(Box37, { sx: styles_default41.photo, children: /* @__PURE__ */ jsx100(
      "img",
      {
        src: contributor?.avatar,
    ...
    /* @__PURE__ */ jsx100(Text27, { children: contributor?.name })
  ] });
};
...
import { Text as Text28 } from "@vtex/brand-ui";
...
var TimeToRead = ({ minutes }) => {
  ...
  return /* @__PURE__ */ jsx101(Text28, { sx: styles_default42.readingTime, children: template.replace("{minutes}", minutes) });
};
var time_to_read_default = TimeToRead;

// src/components/troubleshooting-card/index.tsx
import { Box as Box38, Link as Link14, Text as Text29 } from "@vtex/brand-ui";
...
var TroubleshootingCard = ({
  ...
  if (variant === "helpcenter") {
    return /* @__PURE__ */ jsx102(Link14, { href: cardHref, children: /* @__PURE__ */ jsxs80(Box38, { sx: styles_default43.helpcenterContainer, children: [
      /* @__PURE__ */ jsx102(Text29, { sx: styles_default43.title, className: "title", children: title9 }),
      hasStructuredTags ? /* @__PURE__ */ jsxs80(Box38, { sx: styles_default43.groupsContainer, children: [
        resolvedSymptomFilters.length > 0 && /* @__PURE__ */ jsx102(Box38, { sx: styles_default43.groupContainer, children: /* @__PURE__ */ jsx102(Box38, { sx: styles_default43.helpcenterTagsContainer, children: resolvedSymptomFilters.map((filter) => /* @__PURE__ */ jsx102(
          tag_default,
          {
        ...
        resolvedDomainFilters.length > 0 && /* @__PURE__ */ jsx102(Box38, { sx: styles_default43.groupContainer, children: /* @__PURE__ */ jsx102(Box38, { sx: styles_default43.helpcenterTagsContainer, children: resolvedDomainFilters.map((filter) => /* @__PURE__ */ jsx102(tag_default, { sx: styles_default43.tag, color: "Gray", children: filter }, `domain-${filter}`)) }) })
      ] }) : null
    ] }) });
  }
  return /* @__PURE__ */ jsx102(Link14, { href: cardHref, sx: styles_default43.devportalContainer, children: /* @__PURE__ */ jsxs80(Box38, { children: [
    /* @__PURE__ */ jsx102(Text29, { sx: styles_default43.title, className: "title", children: title9 }),
    description6 ? /* @__PURE__ */ jsx102(Text29, { sx: styles_default43.description, className: "description", children: description6 }) : null,
    /* @__PURE__ */ jsxs80(Box38, { sx: styles_default43.tagsContainer, children: [
      resolvedSymptomFilters.length > 0 && /* @__PURE__ */ jsx102(Box38, { sx: styles_default43.tagGroup, children: resolvedSymptomFilters.map((filter) => /* @__PURE__ */ jsx102(tag_default, { sx: styles_default43.tag, color: "Blue", children: filter }, `symptom-${filter}`)) }),
      resolvedDomainFilters.length > 0 && /* @__PURE__ */ jsx102(Box38, { sx: styles_default43.tagGroup, children: resolvedDomainFilters.map((filter) => /* @__PURE__ */ jsx102(tag_default, { sx: styles_default43.tag, color: "Gray", children: filter }, `domain-${filter}`)) }),
      !hasStructuredTags && fallbackTags.map((moduleTag) => /* @__PURE__ */ jsx102(tag_default, { sx: styles_default43.tag, color: "Gray", children: moduleTag }, `tags-${moduleTag}`))
    ] })
  ] }) });
};
...
var DocumentationUpdatesIcon = (props) => /* @__PURE__ */ jsxs82(
  Icon54,
  {
    ...props,
    viewBox: "0 0 24 25",
...
var HelpCenterIcon = (props) => /* @__PURE__ */ jsxs83(
  Icon55,
  {
    ...props,
    viewBox: "0 0 64 65",
...
var DeveloperPortalIcon = (props) => /* @__PURE__ */ jsxs84(
  Icon56,
  {
    ...props,
    viewBox: "0 0 24 24",
    ...
    children: [
      ...
      /* @__PURE__ */ jsx106("path", { d: "M3 7L21 7", stroke: "#4A596B", strokeWidth: "1.5" }),
      /* @__PURE__ */ jsx106(
        "path",
        {
...
var FAQIcon = (props) => /* @__PURE__ */ jsxs85(
  Icon57,
  {
    ...props,
    viewBox: "0 0 24 25",
...
var KnownIssueIcon = (props) => /* @__PURE__ */ jsxs86(
  Icon58,
  {
    ...props,
    viewBox: "0 0 256 256",
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      /* @__PURE__ */ jsx108("rect", { width: "16rem", height: "16rem", fill: "none" }),
      /* @__PURE__ */ jsx108(
        "line",
        {
          x1: "104",
...
var MegaphoneIcon = (props) => /* @__PURE__ */ jsxs87(
  Icon59,
  {
    ...props,
    viewBox: "0 0 24 20",
...
var GraphIcon = (props) => /* @__PURE__ */ jsxs88(
  Icon60,
  {
    ...props,
    viewBox: "0 0 20 20",
...
var WarningIcon = (props) => /* @__PURE__ */ jsxs89(
  Icon61,
  {
    ...props,
    viewBox: "0 0 18 16",
...
var StartHereIcon = (props) => /* @__PURE__ */ jsxs90(
  Icon62,
  {
    ...props,
    viewBox: "0 0 24 24",
...
var TutorialsIcon = (props) => /* @__PURE__ */ jsxs91(
  Icon63,
  {
    ...props,
    viewBox: "0 0 24 24",
...
var AnnouncementIcon = (props) => /* @__PURE__ */ jsxs92(
  Icon64,
  {
    ...props,
    viewBox: "0 0 256 256",
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      /* @__PURE__ */ jsx114("rect", { width: "16rem", height: "16rem", fill: "none" }),
      /* @__PURE__ */ jsx114(
        "path",
        {
...
var InfoIcon = (props) => /* @__PURE__ */ jsxs93(
  Icon65,
  {
    ...props,
    viewBox: "0 0 16 16",
...
var NewIcon = (props) => /* @__PURE__ */ jsxs94(
  Icon66,
  {
    ...props,
    viewBox: "0 0 17 16",
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      /* @__PURE__ */ jsx116("circle", { cx: "8.50146", cy: "8", r: "8", fill: "#F71963" }),
      /* @__PURE__ */ jsxs94("g", { clipPath: "url(#clip0_462_17766)", children: [
        /* @__PURE__ */ jsx116(
          "path",
          {
      ...
      /* @__PURE__ */ jsx116("defs", { children: /* @__PURE__ */ jsx116("clipPath", { id: "clip0_462_17766", children: /* @__PURE__ */ jsx116(
        "rect",
        {
          width: "11",
          height: "9",
...
var GithubIcon = (props) => /* @__PURE__ */ jsx117(
  Icon67,
  {
    ...props,
    viewBox: "0 0 64 65",
...
var CommunityIcon = (props) => /* @__PURE__ */ jsxs95(
  Icon68,
  {
    ...props,
    viewBox: "0 0 64 65",
...
var TwitterCircleIcon = (props) => /* @__PURE__ */ jsxs96(
  Icon69,
  {
    ...props,
    viewBox: "0 0 33 33",
...
import { Fragment as Fragment10, jsx as jsx120, jsxs as jsxs97 } from "react/jsx-runtime";
var CheckboxIcon = (props) => /* @__PURE__ */ jsx120(
  Icon70,
  {
    ...props,
    viewBox: "0 0 20 20",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg",
    children: !props.checked ? /* @__PURE__ */ jsxs97(Fragment10, { children: [
      /* @__PURE__ */ jsx120(
        "rect",
        {
          x: "0.5",
    ...
    ] }) : /* @__PURE__ */ jsxs97(Fragment10, { children: [
      /* @__PURE__ */ jsx120("rect", { width: "20", height: "20", rx: "4", fill: "#0C1522" }),
      /* @__PURE__ */ jsx120(
        "path",
        {
          fillRule: "evenodd",
...
var ResizeIcon = (props) => /* @__PURE__ */ jsx121(
  Icon71,
  {
    ...props,
...
var ArrowRightIcon = (props) => /* @__PURE__ */ jsxs98(
  Icon72,
  {
    ...props,
    viewBox: "0 0 17 17",
