...
declare const Card: ({ children, title: titleProp, description: descriptionProp, linkTitle: linkTitleProp, linkTo: linkToProp, image: imageProp, }: CardProps) => react_jsx_runtime.JSX.Element;
